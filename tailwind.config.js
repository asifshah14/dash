  ...
  theme: {
    extend: {
      colors: {
        ...
        'border-light': '#e2e8f0',
        'border-dark': '#1e293b',
        'brand-blue-start': '#0F62FE',
        'brand-blue-light': '#60a5fa',
        'brand-blue-mid': '#3b82f6',
        'brand-blue-dark': '#2563eb',
        'brand-blue-end': '#4D9BFF',
        'brand-teal-start': '#0891B2',
        'brand-teal-light': '#2dd4bf',
        'brand-teal-mid': '#14b8a6',
        'brand-teal-dark': '#0d9488',
        'brand-teal-end': '#22D3EE',
        'brand-emerald-start': '#059669',
        'brand-emerald-light': '#34d399',
        'brand-emerald-mid': '#10b981',
        'brand-emerald-dark': '#059669',
        'brand-emerald-end': '#34D399',
        'brand-coral-start': '#F97316',
        'brand-coral-mid': '#fb923c',
        'brand-coral-end': '#FDBA74',
        'brand-amber-start': '#F59E0B',
        'brand-amber-mid': '#fbbf24',
        'brand-amber-end': '#FCD34D',
